...
try:
    ...
    raise SystemExit("❌ Module coinbase_advanced_py not found in vendor/")
...
try:
    ...
    raise SystemExit("❌ coinbase_advanced_py has no attribute 'Client'. Check vendored package version.")
